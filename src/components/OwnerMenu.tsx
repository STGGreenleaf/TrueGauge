    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Menu Panel */}
          <div className="absolute right-0 top-full mt-2 z-50 w-64 rounded-lg border border-violet-500/30 bg-black/90 backdrop-blur-sm shadow-xl shadow-violet-500/10">
